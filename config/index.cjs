...
const USER_CONFIG = {
    ...
    // 如果你非要填这里也行。脚本也能运行
    APP_ID: 'wxce8abdbb754fb24c',
  
    // 使用微信测试号时才需要填写：公众号APP_SECRET
    // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
    // 如果你非要填这里也行。脚本也能运行
    APP_SECRET: '17eb5b068679d1564ae10ad0857524bd',
    ...
    TIAN_API: {
      ...
      key: '6d55f5b35b4aa48fb1c86c3c7aeebbd2',
    ...
    USERS: [
      {
        ...
        useTemplateId: 'jM28W5ubzfQwu67CMlfT4DlphOyXjmtB0ybe0Wqb6qEw',
        // 所在省份或城市，也可以不填
        province: '',
        // 所在城市或县区
        city: '武汉',
    ...
    CALLBACK_USERS: [
      {
        ...
        // 使用其他通道时，请严格按照各个通道的教程进行填写
        id: 'o9Hve6uycEM3b0LQvdfkaK70-lVU',
      }
      // 你可以不断按格式往下增加
      // ...
    ],
